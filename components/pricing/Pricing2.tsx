...
const PricingOptions2 = () => {
  return (
    <div className="flex flex-col gap-2 justify-center items-center w-full pt-32 lg:pb-4 px-6 z-20 bg-[#FAFAFA]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 place-content-center gap-2 my-20 lg:w-[68%]">
        {pricingOptions.slice(0, 2).map((option, idx) => (
          <div
            className="relative flex flex-col rounded-2xl border-[1px] shadow-md border-gray-200 bg-white gap-4 overflow-hidden w-full h-[690px]"
            key={idx}
          >
        ...
        {pricingOptions.slice(2, 3).map((option, idx) => (
          <div
            className="relative flex flex-col rounded-2xl border-[1px] shadow-md bg-[#171717] text-slate-50 gap-4 overflow-hidden w-full h-[690px]"
            key={idx}
          >
            <div className="absolute w-full h-full backdrop-blur-[100px]"></div>
            ...
            <div className="flex flex-col z-20 absolute px-6 py-6 pt-12 gap-2">
              ...
              <Button className="h-[48px] w-full rounded-xl bg-slate-50 border-[1px] border-gray-200 text-black font-semibold text-base mt-4">
                Get Started Now
              </Button>

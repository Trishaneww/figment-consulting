...
const parallax = [
  [
    ...
    { src: "/assets/parallax/proj28.png", speed: 0.1 },
  ...
  [
    ...
    { src: "/assets/parallax/proj25.png", speed: 0.05 },
    { src: "/assets/parallax/proj13.png", speed: 0.05 },
  ...
  [
    ...
    { src: "/assets/parallax/hero2.png", speed: 0.1 },
    { src: "/assets/parallax/proj5.png", speed: 0.1 },
    { src: "/assets/parallax/proj3.png", speed: 0.1 },
    ...
    { src: "/assets/parallax/hero5.png", speed: 0.1 },
    { src: "/assets/parallax/proj8.png", speed: 0.1 },
  ],
  [
    { src: "/assets/parallax/proj8.png", speed: 0.9 },
    { src: "/assets/parallax/proj26.png", speed: 0.05 },
    { src: "/assets/parallax/proj9.png", speed: 0.05 },
    { src: "/assets/parallax/proj11.png", speed: 0.05 },
          ...
          >
            {column.map(({ src }, rowIndex) => (
              <Image
                src={src}
                key={rowIndex}
                alt={`Parallax ${colIndex}-${rowIndex}`}
                width={1000}
                height={1000}
                className="relative rounded-lg shadow-lg overflow-hidden will-change-transform border-[2px] border-gray-200"
                priority
              />
            ))}
          </div>
